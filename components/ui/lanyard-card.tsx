  ...
  return (
    <>
      <group position={[0, 4, 0]}>
        ...
        <RigidBody position={[2, 0, 0]} ref={card} {...segmentProps} type={(dragged ? "kinematicPosition" : "dynamic") as RigidBodyTypeString}>
          ...
          <group
            ...
            onPointerDown={(e) => {
              ...
              if (card.current && card.current.translation) {
                ...
                drag(new THREE.Vector3().copy((e as any).point).sub(vec.copy(translation)))
              }
            }}
          >
            ...
            <mesh geometry={(nodes as any).clip.geometry} material={(materials as any).metal} material-roughness={0.3 as any} />
      ...
      <mesh ref={band as any}>
        <meshLineGeometry />
        <meshLineMaterial color="white" depthTest={false} resolution={[width, height] as any} useMap map={texture as any} repeat={[-3, 1] as any} lineWidth={1} />
      </mesh>
    </>
  )
}

export function LanyardDemo() {
  return (
